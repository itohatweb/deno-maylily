// Copyright the BigInteger.js authors. Unlicense License.
// Small parts were changed by itohatweb
// Ported from https://github.com/peterolson/BigInteger.js
...
var bigInt = (function (undefined) {
  ...
  SmallInteger.prototype.over = SmallInteger.prototype.divide = BigInteger
    .prototype.over = BigInteger.prototype.divide;
  ...
  SmallInteger.prototype.remainder = SmallInteger.prototype.mod = BigInteger
    .prototype.remainder = BigInteger.prototype.mod;
  ...
  NativeBigInt.prototype.eq = NativeBigInt.prototype.equals = SmallInteger
    .prototype.eq = SmallInteger.prototype.equals = BigInteger.prototype.eq =
      BigInteger.prototype.equals;

  BigInteger.prototype.notEquals = function (v) {
    return this.compare(v) !== 0;
  };
  NativeBigInt.prototype.neq = NativeBigInt.prototype.notEquals = SmallInteger
    .prototype.neq = SmallInteger.prototype.notEquals = BigInteger.prototype
      .neq = BigInteger.prototype.notEquals;

  BigInteger.prototype.greater = function (v) {
    return this.compare(v) > 0;
  };
  NativeBigInt.prototype.gt = NativeBigInt.prototype.greater = SmallInteger
    .prototype.gt = SmallInteger.prototype.greater = BigInteger.prototype.gt =
      BigInteger.prototype.greater;

  BigInteger.prototype.lesser = function (v) {
    return this.compare(v) < 0;
  };
  NativeBigInt.prototype.lt = NativeBigInt.prototype.lesser = SmallInteger
    .prototype.lt = SmallInteger.prototype.lesser = BigInteger.prototype.lt =
  ...
  NativeBigInt.prototype.isProbablePrime = SmallInteger.prototype
    .isProbablePrime = BigInteger.prototype.isProbablePrime;
  ...
  BigInteger.prototype.shiftRight = function (v) {
    ...
    while (n >= powers2Length) {
      if (
        result.isZero() || (result.isNegative() && result.isUnit())
      ) {
        return result;
      }
    ...
    if (base.equals(-1)) {
      ...
      if (n.isNegative()) {
        return {
          value: [].concat.apply(
            [],
            Array.apply(null, Array(-n.toJSNumber()))
  ...
  NativeBigInt.prototype.toJSON = BigInteger.prototype.toJSON = SmallInteger
